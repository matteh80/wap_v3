...
!(function() {
  ...
  function it(t) {
    ...
    var C = []
    return (
      C.push({ tag: 'span', attributes: l, children: [e] }),
      a &&
        C.push({
          tag: 'span',
  ...
  function Ut(t) {
    ...
    return ~x.extra.classes.indexOf(Dt)
      ? (function(t, e) {
          var n = e.title,
            i = e.transform,
            r = e.extra,
      ...
      : ((u = t),
        ...
        [
          u,
          nt({
            icons: { main: Yt(g, p), mask: Yt(y.iconName, y.prefix) },
            prefix: p,
            iconName: g,
            transform: v,
            symbol: b,
  ...
  var ie,
    ...
    se = function() {
      m && S.autoReplaceSvg && oe.dom.i2svg({ node: f })
    }
  Object.defineProperty(oe, 'config', {
    ...
    (function(t) {
      ...
      u &&
        ...
        I(function() {
          Object.keys(R.styles).length > 0 && se(),
            S.observeMutations &&
              ...
              (function(t) {
                if (l) {
                  ...
                  ;(At = new l(function(t) {
                    ...
                    m &&
                      At.observe(f.getElementsByTagName('body')[0], {
                        childList: !0,
                        attributes: !0,
                        characterData: !0,
                        subtree: !0
