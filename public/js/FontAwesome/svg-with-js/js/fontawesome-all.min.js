...
!(function() {
  ...
  (function() {
    ...
    function l(l) {
      c({ autoReplaceSvg: l, observeMutations: l })
    }
    function h(c) {
      return ~rc.indexOf(c)
    }
    function v(c) {
      if (c && void 0 !== Q.createElement) {
        ...
        for (
          var h = Q.head.childNodes, v = null, z = h.length - 1;
          z > -1;
          z--
        ) {
          var e = h[z],
        ...
        return Q.head.insertBefore(l, v), c
      }
    }
    function z() {
      return ++Sc
          ...
          t && lc
            ...
            : t
              ? 'translate(calc(-50% + ' +
                ...
                l.y / yc +
                'em)) '
              : 'translate(' + l.x / yc + 'em, ' + l.y / yc + 'em) '),
        (m +=
          'scale(' +
          l.size / yc * (l.flipX ? -1 : 1) +
          ', ' +
          l.size / yc * (l.flipY ? -1 : 1) +
          ') '),
    ...
    function M(c) {
      var l,
        ...
        n = i.width,
        M = i.height,
        H = 'fa-w-' + Math.ceil(n / M * 16),
        o = [Lc.replacementClass, t ? Lc.familyPrefix + '-' + t : '', H]
          .concat(f.classes)
          .join(' '),
        V = {
          children: [],
      ...
      r &&
        V.children.push({
          tag: 'title',
          attributes: { id: V.attributes['aria-labelledby'] || 'title-' + z() },
          children: [r]
        })
      var C = Mc({}, V, {
          prefix: a,
        ...
        u = L.children,
        d = L.attributes
      return (C.children = u), (C.attributes = d), s ? Oc(C) : xc(C)
    }
    function H(c) {
      var l,
        h = c.content,
        ...
        m = Mc(
          ...
          t.attributes,
          a ? { title: a } : {},
          ((l = {}), nc(l, vc, ''), nc(l, 'class', t.classes.join(' ')), l)
        ),
        s = Mc({}, t.styles)
      f(e) &&
        ((s.transform = n({
      ...
      var M = []
      return (
        M.push({ tag: 'span', attributes: m, children: [h] }),
        a &&
          M.push({
            tag: 'span',
    ...
    function C(c) {
      return Bc[c] || { prefix: null, iconName: null }
    }
    function L(c) {
    ...
    function d(c) {
      ...
      return 'string' == typeof c
        ? m(c)
        : '<' + l + ' ' + s(v) + '>' + e.map(d).join('') + '</' + l + '>'
    }
    function p(c) {
      var l = c.getAttribute ? c.getAttribute('class') : null
      return (
        !!l &&
        (!!~l.toString().indexOf(Lc.replacementClass) ||
          ~l.toString().indexOf('fa-layers-text'))
      )
    }
    function g() {
      return !0 === Lc.autoReplaceSvg
        ? Kc.replace
        : Kc[Lc.autoReplaceSvg] || Kc.replace
    }
    function b(c, l) {
    ...
    function w(c) {
      if (Z) {
              ...
              e(c).forEach(function(c) {
                if (
                  ('childList' === c.type &&
                    ...
                    !p(c.addedNodes[0]) &&
                    (Lc.searchPseudoElements && v(c.target), l(c.target)),
                  'attributes' === c.type &&
                    c.target.parentNode &&
                    Lc.searchPseudoElements &&
                    v(c.target.parentNode),
                  'attributes' === c.type &&
                    p(c.target) &&
                    ~sc.indexOf(c.attributeName))
                )
        ...
        Q.getElementsByTagName &&
          z.observe(Q.getElementsByTagName('body')[0], {
            childList: !0,
            attributes: !0,
            characterData: !0,
            subtree: !0
    ...
    function _(c) {
      ...
      return {
        ...
        symbol: t,
        mask: s,
        extra: { classes: z, styles: e, attributes: m }
      }
    }
    function k(c) {
    ...
    function A(c, l) {
      var h = { found: !1, width: 512, height: 512, icon: tl }
      if (c && l && ml[l] && ml[l][c]) {
        var v = ml[l][c]
        h = {
          found: !0,
    ...
    function x(c, l) {
      ...
      return [
        c,
        M({
          icons: { main: A(h, z), mask: A(t.iconName, t.prefix) },
          prefix: z,
          iconName: h,
          transform: e,
          symbol: a,
    ...
    function O(c, l) {
      ...
      if (lc) {
        ...
        ;(e = m.width / t), (a = m.height / t)
      }
      return (
        Lc.autoA11y && !h && (z.attributes['aria-hidden'] = 'true'),
        [
          c,
          H({
            content: c.innerHTML,
        ...
        e(c.querySelectorAll('*')).forEach(function(c) {
          ;[':before', ':after'].forEach(function(l) {
            ...
            if (
              (z &&
                (z.nextSibling &&
                  z.nextSibling.textContent.indexOf(zc) > -1 &&
                  N(z.nextSibling),
                N(z),
                (z = null)),
              v && !z)
    ...
    function F(c, l) {
      ...
      'function' == typeof dc.hooks.addPack
        ? dc.hooks.addPack(c, h)
        : (dc.styles[c] = Mc({}, dc.styles[c] || {}, h)),
        'fas' === c && F('fa', l)
    }
    function W(c) {
      return {
    ...
    function R(c) {
      var l = c.prefix,
        h = void 0 === l ? 'fa' : l,
        v = c.iconName
      if (v) return u(Ml.definitions, h, v) || u(dc.styles, h, v)
    }
    var B = function() {},
      D = {},
      X = {},
    ...
    var dc = uc.___FONT_AWESOME___,
      ...
      gc = !1
    cc &&
      ((gc = (Q.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(
        Q.readyState
      )) ||
        Q.addEventListener('DOMContentLoaded', function c() {
    ...
    var bc = function(c) {
      ...
      yc = hc,
      wc = { size: 16, x: 0, y: 0, rotate: 0, flipX: !1, flipY: !1 },
      Sc = 0,
      ...
      kc = function(c) {
        var l = c.children,
          ...
          s = e.width,
          r = e.icon,
          f = i({ transform: a, containerWidth: s, iconWidth: t }),
          n = { tag: 'rect', attributes: Mc({}, _c, { fill: 'white' }) },
          M = {
            tag: 'g',
            ...
            children: [
              {
                tag: 'path',
                attributes: Mc({}, m.attributes, f.path, { fill: 'black' })
              }
            ]
          },
          H = { tag: 'g', attributes: Mc({}, f.outer), children: [M] },
          o = 'mask-' + z(),
          V = 'clip-' + z(),
          C = {
            tag: 'defs',
            children: [
              { tag: 'clipPath', attributes: { id: V }, children: [r] },
              {
                tag: 'mask',
                attributes: Mc({}, _c, {
                  id: o,
      ...
      xc = function(c) {
        ...
        if (f(a) && h.found && !v.found) {
          var t = { x: h.width / h.height / 2, y: 0.5 }
          z.style = r(
            Mc({}, e, {
              'transform-origin':
                t.x + a.x / 16 + 'em ' + (t.y + a.y / 16) + 'em'
            })
          )
        }
        ...
        return [
          {
            ...
            children: [
              { tag: 'symbol', attributes: Mc({}, z, { id: a }), children: v }
            ]
          }
        ]
      },
      Ec = function() {},
      Nc =
        Lc.measurePerformance && $ && $.mark && $.measure
          ? $
          : { mark: Ec, measure: Ec },
      qc = function(c) {
        Nc.mark('FA "5.0.4" ' + c + ' ends'),
          Nc.measure(
            'FA "5.0.4" ' + c,
            'FA "5.0.4" ' + c + ' begins',
            'FA "5.0.4" ' + c + ' ends'
    ...
    var Xc = dc.styles,
      ...
      Kc = {
        replace: function(c) {
          ...
          if (l.parentNode && l.outerHTML)
            l.outerHTML =
              h +
              (Lc.keepOriginalSource && 'svg' !== l.tagName.toLowerCase()
                ? '\x3c!-- ' + l.outerHTML + ' --\x3e'
                : '')
      ...
      Qc = function(c) {
        var l = c.getAttribute('data-prefix'),
          ...
          z = L(a(c))
        return (
          l && h && ((z.prefix = l), (z.iconName = h)),
          z.prefix && v.length > 1
            ? (z.iconName = V(z.prefix, c.innerText))
            : z.prefix &&
              1 === v.length &&
              (z.iconName = o(z.prefix, S(c.innerText))),
          z
        )
      },
      Zc = function(c) {
      ...
      ll = function(c) {
        ...
        return (
          Lc.autoA11y &&
            (h
              ? (l['aria-labelledby'] = Lc.replacementClass + '-title-' + z())
              : (l['aria-hidden'] = 'true')),
          l
        )
      },
    ...
    var vl = { fill: 'currentColor' },
      zl = { attributeType: 'XML', repeatCount: 'indefinite', dur: '2s' },
      el = {
        tag: 'path',
        attributes: Mc({}, vl, {
          d:
      ...
      al = Mc({}, zl, { attributeName: 'opacity' }),
      tl = {
        tag: 'g',
        children: [
          el,
          {
            tag: 'circle',
            attributes: Mc({}, vl, { cx: '256', cy: '364', r: '28' }),
            children: [
              {
                tag: 'animate',
                attributes: Mc({}, zl, {
              ...
              {
                tag: 'animate',
                attributes: Mc({}, al, { values: '1;0;1;1;0;1;' })
              }
            ]
          },
          {
            ...
            children: [
              {
                tag: 'animate',
                attributes: Mc({}, al, { values: '1;0;0;0;0;1;' })
              }
            ]
          },
          {
            ...
            children: [
              {
                tag: 'animate',
                attributes: Mc({}, al, { values: '0;0;1;1;0;0;' })
              }
            ]
          }
        ]
      ...
      fl = { Solid: 'fas', Regular: 'far', Light: 'fal', Brands: 'fab' },
      il = function() {
        var c = 'svg-inline--fa',
          l = Lc.familyPrefix,
      ...
      Hl = {
        i2svg: function() {
          ...
          Lc.searchPseudoElements && q(h), T(h, z)
        },
        css: il,
        insertCss: function() {
          v(il())
      ...
      Vl = (function(c) {
        ...
        if (c) {
          var C = c.prefix,
            L = c.iconName,
            u = c.icon
          return I(Mc({ type: 'icon' }, c), function() {
            return (
              P(),
              Lc.autoA11y &&
                (r
                  ? (H['aria-labelledby'] =
                      Lc.replacementClass + '-title-' + z())
                  : (H['aria-hidden'] = 'true')),
              M({
                icons: {
                  main: W(u),
      ...
      Cl = {
        ...
        text: function(c) {
          var l =
            ...
            r = l.styles,
            f = void 0 === r ? {} : r
          return I({ type: 'text', content: c }, function() {
            return (
              P(),
              H({
                content: c,
          ...
          return I({ type: 'layer' }, function() {
            ...
            return (
              ...
              [
                {
                  tag: 'span',
                  attributes: { class: Lc.familyPrefix + '-layers' },
                  children: l
                }
              ]
            )
      ...
      Ll = function() {
        Lc.autoReplaceSvg && Cl.dom.i2svg({ node: Q })
      }
    Object.defineProperty(Cl, 'config', {
      get: function() {
        return Lc
      },
      set: function(l) {
      ...
      (function(c) {
        ...
        cc &&
          (J.FontAwesome || (J.FontAwesome = Cl),
          bc(function() {
            Object.keys(dc.styles).length > 0 && Ll(),
              Lc.observeMutations &&
          ...
          (dc.hooks = Mc({}, dc.hooks, {
            addPack: function(c, l) {
              ;(dc.styles[c] = Mc({}, dc.styles[c] || {}, l)), Dc(), Ll()
            },
            addShims: function(c) {
              var l
              ;(l = dc.shims).push.apply(l, Hc(c)), Dc(), Ll()
            }
          }))
      })
  })()
